...
--
-- Name: idx_*; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX IF NOT EXISTS idx_homework_class_date
    ON public.homework USING btree (class_id, date);

CREATE INDEX IF NOT EXISTS idx_homework_class_subject_date
    ON public.homework USING btree (class_id, subject_id, date);

CREATE INDEX IF NOT EXISTS idx_schedule_class_weekday_weight
    ON public.schedule USING btree (class_id, weekday_id, weight);
...
CREATE INDEX IF NOT EXISTS idx_weekday_class_ids_gin
    ON public.weekday USING gin (class_ids);

CREATE INDEX IF NOT EXISTS idx_teachers_class_ids_gin
    ON public.teachers USING gin (class_ids);
